  ...
  return (
    <div>
      ...
      {(isStaff ? selectedClass !== null && classNums.length > 0 : rows.length > 0) && (
        <div className="bg-white rounded-xl border border-gray-100 overflow-hidden print:shadow-none print:border-black">
          <div className="px-5 py-4 border-b border-gray-50 print:border-black print:block">
                      ...
                      return (
                        ...
                        >
                          {row ? (
                            ...
                            >
                              ...
                              {isStaff && (
                                <button
                                  ...
                                  className="mt-1.5 text-[10px] text-gray-400 hover:text-gray-700 underline transition-colors print:hidden"
                                >
                                  Edit
                                </button>
                              )}
                            ...
                            <button
                              onClick={() => openCell(day, period)}
                              className="w-full rounded-lg flex items-center justify-center text-gray-300 hover:text-[#6fcf6f] hover:bg-[#6fcf6f]/5 transition-colors text-base font-light print:hidden"
                              style={{ minHeight: 52 }}
                            >
                              +
                            </button>
      ...
      {editCell && (
        <>
          <div
            className="fixed inset-0 bg-black/25 z-40 print:hidden"
